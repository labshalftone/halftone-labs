...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            const { data: signInData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email: form.email,
            ...
            if (error) {
                ...
                const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("user_profiles").select("onboarding_completed_at").eq("user_id", signInData.user.id).maybeSingle();
...
_s(LoginPage, "A+aKaOd/LQ1rikXkxo8oIGUm+2M=", false, function() {
    return [
