        ...
        <div className="flex flex-col gap-10">
          ...
          <section>
            ...
            <p className="text-ds-body leading-relaxed text-sm">
              ...
              <span className="font-semibold text-ds-dark">3–5 business days</span> for
          ...
          <section>
            ...
            <p className="text-ds-body leading-relaxed text-sm">
              ...
              <span className="font-semibold text-ds-dark">2–3 business days</span> after
              dispatch, making the total estimated delivery window{" "}
              <span className="font-semibold text-ds-dark">5–7 business days</span> from
              order confirmation.
            </p>
            <p className="text-ds-body leading-relaxed text-sm mt-3">
              We ship via trusted logistics partners including{" "}
              <span className="font-semibold text-ds-dark">Delhivery</span>,{" "}
              <span className="font-semibold text-ds-dark">DTDC</span>, and similar
          ...
          <section>
            ...
            <p className="text-ds-body leading-relaxed text-sm">
              ...
              <span className="font-semibold text-ds-dark">7–14 business days</span> in
              ...
              <span className="font-semibold text-ds-dark">10–20 business days</span>{" "}
          ...
          <section>
            ...
            <p className="text-ds-body leading-relaxed text-sm">
              ...
              <span className="font-semibold text-ds-dark">tracking number and a tracking link</span>.
          ...
          <section>
            ...
            <p className="text-ds-body leading-relaxed text-sm">
              ...
              <span className="font-semibold text-ds-dark">3 times</span>. If delivery
