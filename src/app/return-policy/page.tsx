  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 pt-28 pb-20">
        ...
        {/* Summary card */}
        <div className="bg-white rounded-2xl border border-black/[0.06] p-6 mb-10">
          <p className="text-sm text-ds-body leading-relaxed">
            <span className="font-semibold text-ds-dark">Short version:</span> All Halftone
        ...
        <div className="flex flex-col gap-10">
          ...
          <section>
            ...
            <p className="text-ds-body leading-relaxed text-sm">
              ...
              <span className="font-semibold text-ds-dark">custom-printed to order</span>.
            ...
            <ul className="mt-3 flex flex-col gap-2 text-sm text-ds-body">
              <li className="flex gap-2">
                ...
                <span>
                  ...
                  within{" "}
                  <span className="font-semibold text-ds-dark">48 hours of delivery</span>.
                </span>
              </li>
              <li className="flex gap-2">
                <span className="text-brand font-semibold mt-0.5">—</span>
          ...
          <section>
            ...
            <p className="text-ds-body leading-relaxed text-sm">
              ...
              <span className="font-semibold text-ds-dark">1 hour of placement</span>.
          ...
          <section>
            ...
            <p className="text-ds-body leading-relaxed text-sm mt-3">
              ...
              <span className="font-semibold text-ds-dark">5–7 business days</span> and
