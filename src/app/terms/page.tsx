        ...
        <div className="flex flex-col gap-10">
          ...
          <section>
            ...
            <p className="text-zinc-600 leading-relaxed text-sm">
              ...
              <span className="font-semibold text-zinc-800">halftonelabs.in</span>, you
          ...
          <section>
            ...
            <p className="text-zinc-600 leading-relaxed text-sm">
              ...
              <span className="font-semibold text-zinc-800">Razorpay</span>. We accept
          ...
          <section>
            ...
            <p className="text-zinc-600 leading-relaxed text-sm">
              ...
              <span className="font-semibold text-zinc-800">final</span>. Because every
          ...
          <section>
            ...
            <p className="text-zinc-600 leading-relaxed text-sm">
              ...
              <span className="font-semibold text-zinc-800">Mumbai, Maharashtra, India</span>.
            </p>
          </section>
