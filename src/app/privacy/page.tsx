          ...
          <section>
            ...
            <ul className="mt-3 flex flex-col gap-2 text-sm text-zinc-600">
              <li className="flex gap-2">
                ...
                <span>
                  <span className="font-semibold text-zinc-800">Personal details:</span>{" "}
              ...
              <li className="flex gap-2">
                <span className="text-orange-500 font-black mt-0.5">—</span>
                <span>
                  <span className="font-semibold text-zinc-800">Shipping address:</span>{" "}
              ...
              <li className="flex gap-2">
                <span className="text-orange-500 font-black mt-0.5">—</span>
                <span>
                  <span className="font-semibold text-zinc-800">Uploaded designs:</span>{" "}
              ...
              <li className="flex gap-2">
                <span className="text-orange-500 font-black mt-0.5">—</span>
                <span>
                  <span className="font-semibold text-zinc-800">Order history:</span>{" "}
              ...
              <li className="flex gap-2">
                <span className="text-orange-500 font-black mt-0.5">—</span>
                <span>
                  <span className="font-semibold text-zinc-800">Usage data:</span>{" "}
          ...
          <section>
            ...
            <ul className="mt-3 flex flex-col gap-2 text-sm text-zinc-600">
              <li className="flex gap-2">
                <span className="text-orange-500 font-black mt-0.5">—</span>
                <span>
                  <span className="font-semibold text-zinc-800">Shipping partners</span>{" "}
              ...
              <li className="flex gap-2">
                <span className="text-orange-500 font-black mt-0.5">—</span>
                <span>
                  <span className="font-semibold text-zinc-800">Razorpay</span> receives
            ...
            <ul className="mt-3 flex flex-col gap-2 text-sm text-zinc-600">
              ...
              <li className="flex gap-2">
                ...
                <span>
                  ...
                  <span className="font-semibold text-zinc-800">Supabase</span>, which
