...
const SPECS = [
  { label: "Material", value: "Natural cotton canvas, 10 oz" },
  { label: "Size", value: "38 × 42 cm (standard)" },
  { label: "Handles", value: "Long & short handle options" },
  { label: "Print method", value: "DTG / screen print for bulk" },
      ...
      <main className="bg-ds-dark min-h-screen text-white">
        <section className="pt-36 pb-20 max-w-[1200px] mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <span className="ds-label text-white/30 block mb-6">Products / Tote Bags</span>
            <h1 className="text-4xl md:text-6xl leading-[0.92] mb-8 max-w-3xl" style={{ fontWeight: 700, letterSpacing: "-0.055em" }}>
              ...
              <span className="h-bold-dark">Tote Bags</span>
            </h1>
            <p className="text-white/45 max-w-xl leading-relaxed text-base mb-8">
              Natural cotton canvas, DTG-printed. Reusable, durable, and a great add-on to any merch drop or album release.
            </p>
